...
| Path | Format | Category | SHA-256 | Required | Package Data |
| --- | --- | --- | --- | --- | --- |
| `demo/onboarding-template/README.md` | md | public-demo-artifact | `86d405e58381e5775597977e3775e0aa70f50ff87bdef48a2dacac940599e881` | yes | yes |
| `demo/onboarding-template/company.json` | json | public-demo-artifact | `fe6391e5b8cb4cd888473cb5843e16a4aad87e7e7fd144cbaa13fd3657c7086c` | yes | yes |
| `demo/onboarding-template/prior-packet.json` | json | public-demo-artifact | `f7b5af8e0cfdde9f0bdf778181db166629e0cc8b6f654dc1de4f5f32121f5d55` | yes | yes |
| `examples/company.json` | json | package-data | `1f41125d6afff5a7de0b085a9c1fb35080628c4dba34d3a7dc2422021bd8bc80` | yes | yes |
| `examples/prior-packet.json` | json | package-data | `3f287ac96cb3a5a7a477b0e2332e7c2cb046f9e5b72c6f2289838a9e9a48b880` | no | yes |
| `examples/software-compounder.json` | json | package-data | `c6bef8b98a5570c82396bf77faab8959a9fc7a386da0b9c41f791445052ea144` | yes | yes |

### package maintenance reuse

| Path | Format | Category | SHA-256 | Required | Package Data |
| --- | --- | --- | --- | --- | --- |
| `LICENSE` | text | package-data | `91cdf92bf0f3378b989793b256f81e7fb22d0222152411b79ab0634b3de90b4f` | yes | yes |

### public review reuse

| Path | Format | Category | SHA-256 | Required | Package Data |
| --- | --- | --- | --- | --- | --- |
| `.gitignore` | text | public-file | `b12ee9cd8e1b4fb3b724f04d9750b2d2388b2120fef33ac0a168bff8f53252cc` | no | no |
| `demo/assumption-change-walkthrough.html` | html | public-demo-artifact | `4c155578b08adcdd6f07b916037df2ceebcd43365d741f42b6cbfc8aacb5a84e` | yes | yes |
| `demo/assumption-change-walkthrough.json` | json | public-demo-artifact | `2f42241e2749754f14ef4a266bd36a86d19d7b603dcdf20ada76a49d89644e8c` | yes | yes |
...
| `demo/showcase-dashboard.html` | html | public-demo-artifact | `fa4492e6897ceeb0e1f38965c6937c3c857cc04c88cf47228e0b17bca399a875` | yes | yes |
| `demo/showcase-dashboard.json` | json | public-demo-artifact | `f1d639f37b80dcae6ac9bb15e8e14c20167a9523a28b84cdaf2d0c6004b95cbb` | yes | yes |
...
| Path | Format | Category | SHA-256 | Required | Package Data |
| --- | --- | --- | --- | --- | --- |
| `demo/casebook.html` | html | public-demo-artifact | `87ed3f5ec8772e8337fda29f2289db8476186684a983ec6febfce80d4c7680b7` | yes | yes |
| `demo/casebook.json` | json | public-demo-artifact | `d55f12bd7266f2d7ace2537251cd790ee9852a63ad66b3a164515a4ed3475221` | yes | yes |
| `demo/casebook.md` | md | public-demo-artifact | `07dd03bceab556aefb4448f6ba5d262e5fc1bf19d0bea6e51f333b463bb5de31` | yes | yes |
| `demo/decision-journal.json` | json | public-demo-artifact | `b563bcc104b3d0cc51c71b0030f3223d06d2dbe65f9f90ff86237bdabb9726e0` | yes | yes |
| `demo/decision-journal.md` | md | public-demo-artifact | `f5396dc6d7ea4b4b67d0118ebdd6260b1f829dfda4e150de5ec831fa019debae` | yes | yes |
| `demo/multi-company-demo-gallery.html` | html | public-demo-artifact | `22f93a2089e60f12ae1876eeb8e0f4829cefe37975ee791fbb1417b49a53bdd2` | yes | yes |
| `demo/multi-company-demo-gallery.json` | json | public-demo-artifact | `c27f07de56dc690215bc25a14f88822db9738ac9eed208f612dcbc8b914dde4d` | yes | yes |
| `demo/multi-company-demo-gallery.md` | md | public-demo-artifact | `f19cfddfec07ef908fdea82b2f4a47ae26d81680b58a7bd5c0409ce40f330c8e` | yes | yes |
| `demo/scenario-library.html` | html | public-demo-artifact | `662e03f6c1d8ad9a9ae324ee4b2daba20021cc4c21bff9fc76043d9105be1480` | yes | yes |
| `demo/scenario-library.json` | json | public-demo-artifact | `5592fa11c6dd305336973056512a2d0e86f6426ffc9715fb89ea773a69e88651` | yes | yes |
| `demo/scenario-library.md` | md | public-demo-artifact | `65f4dbda4cedb24b1fcfe9682a640d7fad5f15491f4be7a443c9bc189d663949` | yes | yes |
| `demo/sensitivity-matrix.json` | json | public-demo-artifact | `a121adccfbc75b98bdd97d28f8522314acaec80a1d36987fdebfaf5f48354454` | yes | yes |
| `demo/sensitivity-matrix.md` | md | public-demo-artifact | `95bb5e57d5e939dbd5465adeaa275d83ba391e4940e9034ada1f62e8c55ad43c` | yes | yes |
| `demo/thesis-brief.html` | html | public-demo-artifact | `cb4b416ed28d3e8c32f585e4aadb482ab416b1f5a77bba28e60e119800ed9395` | yes | yes |
| `demo/thesis-brief.json` | json | public-demo-artifact | `03cd9c1e8758e6a5b97485dcad527015fc085b354a9a809e4ba9709f491d4dad` | yes | yes |
| `demo/thesis-brief.md` | md | public-demo-artifact | `29bdf36bf36c4717b0801b92faed5734629a37c393d9d50a4eb34b64a57f6718` | yes | yes |
| `demo/valuation-packet.html` | html | public-demo-artifact | `e7c9b0f2c2f69d563ddd11350c54f4c42166d9fdfd8130f41cccae124071b5b3` | yes | yes |
| `demo/valuation-packet.json` | json | public-demo-artifact | `3d734f1c1c4a12f0e7fb658f3f698db757893bbc8c5401e693dca98f84dea4fd` | yes | yes |
| `demo/valuation-packet.md` | md | public-demo-artifact | `7d583f202732d141b0ddfa50b9fb932fd61a2524219bc420562fe8f22ab91c36` | yes | yes |
...
| Path | Format | Category | SHA-256 | Required | Package Data |
| --- | --- | --- | --- | --- | --- |
| `demo/onboarding-template/review-policy.json` | json | public-demo-artifact | `56b95f5cb808f80ad2c2dc9dbdab0aef378241117e678868ddeadbe09b23eeff` | yes | yes |
| `examples/review-policy.json` | json | package-data | `6c6ce8bf0f676d75ebae1a93e62e8d18bf51952522fcbf6ce74d44c4ba03a5df` | no | yes |

### fixture diagnostics and remediation
...
| Path | Format | Category | SHA-256 | Required | Package Data |
| --- | --- | --- | --- | --- | --- |
| `demo/review-ledger.json` | json | public-demo-artifact | `9187eda32b060fedf9950b955a85ac7f6beb00b31384666547ddc076996e307c` | yes | yes |
| `demo/review-ledger.md` | md | public-demo-artifact | `0515577fe3939fc30e1dbbcbbc22da310517273f29378bf2cc7e01be2523fa7a` | yes | yes |
| `demo/reviewer-scorecard.html` | html | public-demo-artifact | `e29fdfa57e321271e174e2f659f9b33d70f3ec8bcdd61ab2c41a71e3c8baec5e` | yes | yes |
| `demo/reviewer-scorecard.json` | json | public-demo-artifact | `6adb12928e99846288322573b1fe8f1f2b078f45552ec628b0d6c3f14913b38d` | yes | yes |
| `demo/reviewer-scorecard.md` | md | public-demo-artifact | `d3062c9115253e6b1a49d7b8a1303dd8528b57f1284c20aa73ec1fa97efc910f` | yes | yes |
| `demo/troubleshoot.html` | html | public-demo-artifact | `5fc77cf5486ba611c28a6886c50ab7089d920930768d0345ad9e8d215022d585` | yes | yes |
| `demo/troubleshoot.json` | json | public-demo-artifact | `3bd41366d75b151dcc084cb199ddd0d40abad4bedbe7563656ba820c49622ee5` | yes | yes |
| `demo/troubleshoot.md` | md | public-demo-artifact | `3e89c3b5c24a3c6818520a8bc5d7b850f67b8236304a8ee89f1eb579cca8b036` | yes | yes |
...
- `demo/artifact-catalog.html`: Generated catalog output; excluded from its own hash index.
- `demo/artifact-catalog.json`: Generated catalog output; excluded from its own hash index.
- `demo/artifact-catalog.md`: Generated catalog output; excluded from its own hash index.
