...
- local wheel: `python -m pip install --no-index --find-links dist valuation_scenario_lab-1.3.0-py3-none-any.whl`
  Expected: `Successfully installed valuation-scenario-lab-1.3.0`
...
- `dist/valuation_scenario_lab-1.3.0-py3-none-any.whl`: ok
- `dist/valuation_scenario_lab-1.3.0.tar.gz`: ok
